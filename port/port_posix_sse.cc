...
// Used to fetch a naturally-aligned 32-bit word in little endian 
yte-order
...
#if defined(_M_X64) || defined(__x86_64__)  // LE_LOAD64 is only used 
n x64.

// Used to fetch a naturally-aligned 64-bit word in little endian 
yte-order
